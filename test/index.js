...
describe('Oppsy', function () {
    ...
    describe('network information', function () {
        ...
        it('reports on network activity', function (done) {
           ...
           var network = new Network(server);
    ...
    describe('os information', function () {
        ...
        describe('loadavg()', function () {
            ...
            it('returns an object with the current load average', function (done) {

                Os.loadavg(function (err, load) {
                    expect(err).to.not.exist();
        ...
        describe('uptime()', function () {
            ...
            it('returns an object with the current uptime', function (done) {

                Os.uptime(function (err, uptime) {
                    expect(err).to.not.exist();
    ...
    describe('process information', function () {
      describe('memory()', function () {
          ...
          it('passes the current memory usage to the callback', function (done) {
              ...
              Process.memoryUsage(function (err, mem) {
      ...
      describe('delay()', function () {
          ...
          it('passes the current event queue delay to the callback', function (done) {
              ...
              Process.delay(function (err, delay) {
