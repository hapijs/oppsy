...
module.exports = internals.Network = function (server) {
...
internals.Network.prototype._onRequest = function (request, event, tags) {
...
internals.Network.prototype._onResponse = function (request) {
...
internals.Network.prototype.reset = function () {
...
internals.Network.prototype.requests = function (callback) {

    callback(null, this._requests);
};


internals.Network.prototype.concurrents = function (callback) {
...
internals.Network.prototype.responseTimes = function (callback) {
...
internals.Network.prototype.sockets = function (httpAgents, httpsAgents, callback) {
