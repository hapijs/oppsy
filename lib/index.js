...
class Oppsy extends Events.EventEmitter {
  constructor(server, config) {
      ...
      this._tasks = {
          ...
          concurrents: this._networkMonitor.concurrents.bind(this._networkMonitor),
          responseTimes: this._networkMonitor.responseTimes.bind(this._networkMonitor),
          sockets: this._networkMonitor.sockets.bind(this._networkMonitor)
      };
  }
